...
class SortTool {
    public:
        ...
        void        QuickSort_for2Don1stElement(std::vector<std::vector<int>>&);
    ...
    private:
        ...
        void        QuickSortSubVector_for2Don1stElement(std::vector<std::vector<int>>&, int, int);
        int         RandomizedPartition(vector<int>&, int, int); // randomized partition the subvector
        int         RandomizedPartition_for2Don1stElement(std::vector<std::vector<int>>&, int, int);
